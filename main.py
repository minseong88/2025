foods = [
    {
        ...
        "song_recommendation": "⚡️ 스트레스 해소에 딱! 에너제틱한 K-POP! (예: NewJeans - Super Shy)"
    },
    {
        "name": "달콤 촉촉 크로플",
        "category": "디저트",
        ...
        "song_recommendation": "🎶 달달함 충전! 편안하고 감미로운 발라드 (예: IU - Bluming)"
    },
    {
        "name": "시원한 김치찌개 & 라면사리",
        "category": "한식",
        ...
        "song_recommendation": "🌶️ 속풀이엔 역시! 밴드 음악으로 얼큰하게! (예: 혁오 - 위잉위잉)"
    },
    {
        "name": "바삭촉촉 치킨 & 콜라",
        "category": "패스트푸드",
        ...
        "song_recommendation": "🎉 친구들과 함께! 파티 분위기 UP! 신나는 힙합 (예: Zico - 새삥)"
    },
    {
        "name": "새콤달콤 비빔밥",
        "category": "한식",
        ...
        "song_recommendation": "🌿 깔끔하고 상쾌한 느낌! 인디 팝 (예: 잔나비 - 주저하는 연인들을 위해)"
    },
    {
        "name": "명랑 핫도그 & 케찹+머스타드",
        "category": "간식",
        ...
        "song_recommendation": "🎧 귀여운 간식 타임! 상큼 발랄한 걸그룹 노래 (예: IVE - LOVE DIVE)"
    },
    {
        "name": "시원한 냉면",
        "category": "한식",
        ...
        "song_recommendation": "❄️ 더위 싹 날리는 시원함! 청량한 댄스곡 (예: Red Velvet - Psycho)"
    },
    {
        "name": "달콤한 허니브레드",
        "category": "디저트",
        ...
        "song_recommendation": "☕️ 따뜻하고 부드러운 분위기! 감성적인 재즈 팝 (예: Crush - Beautiful)"
    },
    {
        "name": "알리오 올리오 파스타",
        "category": "양식",
        ...
        "song_recommendation": "🍝 트렌디한 감성! 세련된 R&B (예: DEAN - D (half moon))"
    },
    {
        "name": "상큼한 요거트 아이스크림",
        "category": "디저트",
        ...
        "song_recommendation": "🍦 상큼 발랄! 기분 전환에 최고! 청량한 팝송 (예: TWICE - Cheer Up)"
    },
]
...
st.markdown("##### 🍕 음식과 음악의 완벽 조합을 찾아줄게요! 🎶") # 새로운 부제목 추가
st.markdown("---") # 구분선
...
if recommended_foods:
    ...
    for i in range(display_count):
        with cols[i]:
            ...
            # === 음악 추천 추가된 부분 ===
            st.markdown(f"**🎧 음악 추천:** {food['song_recommendation']}")
            # =========================
            st.markdown("---")
...
if st.button("🍽️ 오늘의 메뉴 룰렛 돌리기!"):
    ...
    with col2:
        ...
        # === 음악 추천 추가된 부분 ===
        st.markdown(f"**🎧 음악 추천:** {random_food['song_recommendation']}")
        # =========================
